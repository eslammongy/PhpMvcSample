    ...
    <article>
        <header class="section background-white">
            <div class="line text-center">
                <h1 class="text-dark text-s-size-30 text-m-size-40 text-l-size-headline text-thin text-line-height-1">
                    Contact Us</h1>
                <p class="margin-bottom-0 text-size-16 text-dark">Duis autem vel eum iriure dolor in hendrerit in
        ...
        <section class="full-width background-dark">
            <div class="s-12 m-12 l-6">
                ...
                <div style="background-image: url(<?php echo ASSETS ?>template/img/img-contact.jpg);"
            ...
            <div class="s-12 m-12 l-6 text-center">
                <div class="padding-2x">
                    ...
                    <a class="text-primary-hover"
                        href="mailto:contact@sampledomain.com">contact@sampledomain.com</a><br>
        ...
        <section class="section background-white">
            <div class="s-12 m-12 l-4 center">
                ...
                <form name="contactForm" class="customform" method="post">
                    ...
                    <div class="s-12">
                        <textarea name="message" class="required message" placeholder="Your message"
                            rows="3"></textarea>
